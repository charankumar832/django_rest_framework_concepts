...
from movie_app.api.views import (MovieDetailGV,MovieListGV, StreamPlatformListGV
                                ,StreamPlatformDetailGV, ReviewListGV, ReviewDetailGV,
                                     ReviewCreateGV,UserReview, UserReviewParam)
...
urlpatterns = [
    ...
    path('review/<str:username>/', UserReview.as_view(), name='review-username'),
    path('review/', UserReviewParam.as_view(), name='review-param-username'),
]
